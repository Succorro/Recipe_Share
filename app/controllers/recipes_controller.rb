class RecipesController < ApplicationController
  ...
  private
    ...
    def recipe_params
      params.require(:recipe).permit(:id, :title, :description, :instructions, :prep_time, :cooking_time, :user_id, :ingredients_attributes => [:id, :name, :qty, :unit, :_destroy], :recipe_tags_attributes => [:id, :tag_id, :_destroy] )
    end
end
